...
[View My Resume](Jesse_Baranowski_Resume.pdf) &nbsp;|&nbsp; [Connect with me on LinkedIn](https://www.linkedin.com/in/jesse-baranowski-341511264/) 
...
- - Datacom Service Desk Job Simulation - [View My Certificate](Service_Desk_Sim_Forage_certificate.pdf)
...
**Summary:** As part of a Virginia Tech project management course, we were tasked to work with a non-profit organization, meet their stakeholders, and discuss what our team could do to benefit the organization for years to come. My team partnered with a local high school's DECA club — a student-run business/marketing organization — to build them a new website. In the end my team was tasked with creating two separate websites: One to serve as the DECA club's new site, and one to document our project deliverables for our professor.
